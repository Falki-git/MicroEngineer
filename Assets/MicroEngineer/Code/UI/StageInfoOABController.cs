...
namespace MicroEngineer.UI
{
    public class StageInfoOABController : MonoBehaviour
    {
        ...
        private static readonly ILogger Logger = ReduxLib.ReduxLib.GetLogger("MicroEngineer.StageInfoOABController");
            ...
            for (int i = stages.Count - 1; i >= 0; i--)
            {
                ...
                if (string.IsNullOrEmpty(stage.SituationCelestialBody))
                {
                    ...
                    celestialBodyDropdown.RegisterCallback<MouseDownEvent>(evt =>
                    {
                        ...
                        // on the control and selecting something from it, the event will cause the UI to refresh (destroy
