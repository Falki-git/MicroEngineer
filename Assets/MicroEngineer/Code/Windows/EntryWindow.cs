...
namespace MicroEngineer.Windows
{
    public class EntryWindow : BaseWindow
    {
        ...
        [JsonProperty] public string Abbreviation;
        [JsonProperty] public string Description; // not used

        [JsonProperty] public bool IsEditorPoppedOut;
        [JsonProperty] public bool IsFlightPoppedOut;
        [JsonProperty] public bool IsMapPoppedOut;
        ...
        {
            get => MainWindow == MainWindow.None;
        }
        ...
        {
            get => MainWindow != MainWindow.StageInfoOAB;
        }
        ...
        [JsonProperty] public MainWindow MainWindow;

        [JsonProperty] public List<BaseEntry> Entries;
