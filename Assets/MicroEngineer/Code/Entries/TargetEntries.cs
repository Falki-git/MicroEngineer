...
namespace MicroEngineer.Entries
{
    ...
    public class DistanceToTarget : TargetEntry
    {
        ...
        public override void RefreshData()
        {
            EntryValue = Utility.ActiveVessel.TargetObject?.Orbit != null
                ? (Utility.ActiveVessel.Orbit.Position - Utility.ActiveVessel.TargetObject.Orbit.Position).magnitude
                : null;
        }
        ...
        public override string ValueDisplay
        {
            get
            {
                ...
                return Utility.ActiveVessel.Orbit.referenceBody == Utility.ActiveVessel.TargetObject.Orbit.referenceBody
                    ? String.IsNullOrEmpty(this.Formatting)
                        ? EntryValue.ToString()
                        : String.Format(Formatting, EntryValue)
                    : "-";
            }
        }
    }
    ...
    public class RelativeSpeed : TargetEntry
    {
        ...
        {
            EntryValue = Utility.ActiveVessel.TargetObject?.Orbit != null
                ? (Utility.ActiveVessel.Orbit.relativeVelocity -
                   Utility.ActiveVessel.TargetObject.Orbit.relativeVelocity).magnitude
                : null;
        }
        ...
        public override string ValueDisplay
        {
            get
            {
                ...
                return String.IsNullOrEmpty(base.Formatting)
                    ? EntryValue.ToString()
                    : String.Format(base.Formatting, EntryValue);
            }
        }
    }
    ...
    public class Target_Eccentricity : TargetEntry
    {
        public Target_Eccentricity()
        {
            Name = "Eccentricity";
            Description =
                "Shows the target's orbital eccentricity which is a measure of how much an elliptical orbit is 'squashed'.";
            Category = MicroEntryCategory.Target;
            IsDefault = false;
            BaseUnit = null;
            NumberOfDecimalDigits = 3;
    ...
    public class Target_TrueAnomaly : TargetEntry
    {
        public Target_TrueAnomaly()
        {
            Name = "True anomaly";
            Description =
                "Angle between the direction of periapsis and the current position of the object, as seen from the main focus of the ellipse.";
            Category = MicroEntryCategory.Target;
            IsDefault = false;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
        ...
        public override string ValueDisplay
        {
            get
            {
                ...
                return String.IsNullOrEmpty(base.Formatting)
                    ? EntryValue.ToString()
                    : String.Format(Formatting, Utility.RadiansToDegrees((double)EntryValue));
            }
        }
    }
    ...
    public class Target_MeanAnomaly : TargetEntry
    {
        public Target_MeanAnomaly()
        {
            Name = "Mean anomaly";
            Description =
                "Parameter used to describe the position of the target in its orbit around the celestial body.";
            Category = MicroEntryCategory.Target;
            IsDefault = false;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
        ...
        public override string ValueDisplay
        {
            get
            {
                ...
                return String.IsNullOrEmpty(base.Formatting)
                    ? EntryValue.ToString()
                    : String.Format(Formatting, (double)EntryValue * PatchedConicsOrbit.Rad2Deg);
            }
        }
    }
    ...
    public class Target_EccentricAnomaly : TargetEntry
    {
        public Target_EccentricAnomaly()
        {
            ...
            Description =
                "Angle at the center of the orbital ellipse from the semi major axis to the line that passes through the center of the ellipse and the point on the auxiliary circle that is the intersection of the line perpendicular to the semi major axis and passes through the point in the orbit where the target is.";
            Category = MicroEntryCategory.Target;
            IsDefault = false;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
    ...
    public class Target_ArgumentOfPeriapsis : TargetEntry
    {
        public Target_ArgumentOfPeriapsis()
        {
            Name = "Argument of Pe.";
            Description =
                "Angle from the line of the ascending node on the equatorial plane to the point of periapsis passage.";
            Category = MicroEntryCategory.Target;
            IsDefault = false;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
    ...
    public class PhaseAngle : TargetEntry
    {
        public PhaseAngle()
        {
            Name = "Phase angle";
            Description =
                "Angle between your vessel, the reference body and the target. How much \"ahead\" or \"behind\" in phase you are with the target.";
            Category = MicroEntryCategory.Target;
            IsDefault = true;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
    ...
    public class TransferAngle : TargetEntry
    {
        public TransferAngle()
        {
            Name = "Transfer angle";
            Description =
                "Phase angle needed for an optimal Hohmann transfer orbit. Use a circular orbit for a more accurate value.";
            Category = MicroEntryCategory.Target;
            IsDefault = true;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
    ...
    public class DistanceAtCloseApproach1 : TargetEntry
    {
        ...
        public override void RefreshData()
        {
            ...
            EntryValue = isValid != null && isValid == true
                ? Utility.ActiveVessel.Orbiter.OrbitTargeter.Intersect1Target.RelativeDistance
                : null;
        }
    ...
    public class TimeToCloseApproach1 : TargetEntry
    {
        ...
        public override void RefreshData()
        {
            ...
            EntryValue = isValid != null && isValid == true
                ? EntryValue = Utility.ActiveVessel.Orbiter.OrbitTargeter.Intersect1Target.UniversalTime -
                               Utility.UniversalTime
                : null;
        }
    }
    ...
    public class RelativeSpeedAtCloseApproach1 : TargetEntry
    {
        ...
        public override void RefreshData()
        {
            ...
            EntryValue = isValid != null && isValid == true
                ? EntryValue = Utility.ActiveVessel.Orbiter.OrbitTargeter.Intersect1Target.RelativeSpeed
                : null;
        }
    ...
    public class DistanceAtCloseApproach2 : TargetEntry
    {
        ...
        public override void RefreshData()
        {
            ...
            EntryValue = isValid != null && isValid == true
                ? EntryValue = Utility.ActiveVessel.Orbiter.OrbitTargeter.Intersect2Target.RelativeDistance
                : null;
        }
    ...
    public class TimeToCloseApproach2 : TargetEntry
    {
        ...
        public override void RefreshData()
        {
            ...
            EntryValue = isValid != null && isValid == true
                ? EntryValue = Utility.ActiveVessel.Orbiter.OrbitTargeter.Intersect2Target.UniversalTime -
                               Utility.UniversalTime
                : null;
        }
    }
    ...
    public class RelativeSpeedAtCloseApproach2 : TargetEntry
    {
        ...
        public override void RefreshData()
        {
            ...
            EntryValue = isValid != null && isValid == true
                ? EntryValue = Utility.ActiveVessel.Orbiter.OrbitTargeter.Intersect2Target.RelativeSpeed
                : null;
        }
