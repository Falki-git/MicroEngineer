...
namespace MicroEngineer.Entries
{
    ...
    public class AutopilotStatus_Mode : MiscEntry
    {
        ...
        public override string ValueDisplay => EntryValue != null
            ? (AutopilotMode)EntryValue == AutopilotMode.StabilityAssist ? "Stability" : EntryValue.ToString()
            : null;
    }
    ...
    public class AltimeterMode : MiscEntry
    {
        ...
        public override string ValueDisplay => EntryValue != null
            ? (AltimeterDisplayMode)EntryValue == AltimeterDisplayMode.SeaLevel ? "Sea Level" :
            (AltimeterDisplayMode)EntryValue == AltimeterDisplayMode.GroundLevel ? "Ground Level" : "-"
            : "-";
    }
