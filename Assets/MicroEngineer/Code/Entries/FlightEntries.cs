...
namespace MicroEngineer.Entries
{
    ...
    public class GeeForce : FlightEntry
    {
        public GeeForce()
        {
            Name = "G-Force";
            Description =
                "Measurement of the type of force per unit mass – typically acceleration – that causes a perception of weight, with a g-force of 1 g equal to the conventional value of gravitational acceleration on Earth/Kerbin.";
            Category = MicroEntryCategory.Flight;
            IsDefault = true;
            BaseUnit = "g";
    ...
    public class AngleOfAttack : FlightEntry
    {
        public AngleOfAttack()
        {
            Name = "AoA";
            Description =
                "Angle of Attack specifies the angle between the chord line of the wing and the vector representing the relative motion between the aircraft and the atmosphere.";
            Category = MicroEntryCategory.Flight;
            IsDefault = true;
            BaseUnit = "°";
            NumberOfDecimalDigits = 3;
    ...
    public class Pitch_HorizonRelative : FlightEntry
    {
        public Pitch_HorizonRelative()
        {
            Name = "Pitch";
            Description =
                "Lateral axis passes through an aircraft from wingtip to wingtip. Rotation about this axis is called pitch (moving up-down).";
            Category = MicroEntryCategory.Flight;
            IsDefault = true;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
    ...
    public class Roll_HorizonRelative : FlightEntry
    {
        public Roll_HorizonRelative()
        {
            Name = "Roll";
            Description =
                "Longitudinal axis passes through the aircraft from nose to tail. Rotation about this axis is called roll (rotating left-right).";
            Category = MicroEntryCategory.Flight;
            IsDefault = true;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
    ...
    public class Yaw_HorizonRelative : FlightEntry
    {
        public Yaw_HorizonRelative()
        {
            Name = "Yaw";
            Description =
                "Vertical axis passes through an aircraft from top to bottom. Rotation about this axis is called yaw (moving left-right).";
            Category = MicroEntryCategory.Flight;
            IsDefault = true;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
    ...
    public class Zenith : FlightEntry
    {
        public Zenith()
        {
            Name = "Zenith";
            Description =
                "The zenith is an imaginary point directly above a particular location, on the celestial sphere. \"Above\" means in the vertical direction opposite to the gravity direction.";
            Category = MicroEntryCategory.Flight;
            IsDefault = false;
            BaseUnit = "°";
            NumberOfDecimalDigits = 2;
