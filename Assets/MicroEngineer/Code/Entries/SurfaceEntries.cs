...
namespace MicroEngineer.Entries
{
    ...
    public class Latitude : SurfaceEntry
    {
        public Latitude()
        {
            Name = "Latitude (geo)";
            Description =
                "Shows the vessel's latitude position around the celestial body. Latitude is the angle from the equator towards the poles. Geo format.";
    ...
    public class LatitudeDecimal : SurfaceEntry
    {
        public LatitudeDecimal()
        {
            Name = "Latitude";
            Description =
                "Shows the vessel's latitude position around the celestial body. Latitude is the angle from the equator towards the poles. Decimal format.";
            Category = MicroEntryCategory.Surface;
            IsDefault = true;
            BaseUnit = null;
    ...
    public class Longitude : SurfaceEntry
    {
        public Longitude()
        {
            Name = "Longitude (geo)";
            Description =
                "Shows the vessel's longitude position around the celestial body. Longitude is the angle from the body's prime meridian to the current meridian. Geo format.";
            EntryType = EntryType.LatitudeLongitude;
            Category = MicroEntryCategory.Surface;
            IsDefault = false;
            Formatting = null;
    ...
    public class LongitudeDecimal : SurfaceEntry
    {
        public LongitudeDecimal()
        {
            Name = "Longitude";
            Description =
                "Shows the vessel's longitude position around the celestial body. Longitude is the angle from the body's prime meridian to the current meridian. Decimal format.";
            Category = MicroEntryCategory.Surface;
            IsDefault = true;
            BaseUnit = null;
            NumberOfDecimalDigits = 3;
    ...
    public class DynamicPressure_kPa : SurfaceEntry
    {
        public DynamicPressure_kPa()
        {
            ...
            Description =
                "Dynamic Pressure (q) is a defined property of a moving flow of gas. It describes how much pressure the airflow is having on the vessel.";
            Category = MicroEntryCategory.Surface;
            IsDefault = false;
            MiliUnit = "Pa";
            BaseUnit = "kPa";
    ...
    public class StaticPressure_kPa : SurfaceEntry
    {
        public StaticPressure_kPa()
        {
            ...
            Description =
                "Static pressure is a term used to define the amount of pressure exerted by a fluid that is not moving - ambient pressure.";
            Category = MicroEntryCategory.Surface;
            IsDefault = false;
            MiliUnit = "Pa";
            BaseUnit = "kPa";
    ...
    public class AtmosphericTemperature : SurfaceEntry
    {
        public AtmosphericTemperature()
        {
            ...
            Description =
                "Temperature measured outside the vessel. The sensor which detects SAT must be carefully sited to ensure that airflow over it does not affect the indicated temperature.";
            Category = MicroEntryCategory.Surface;
            IsDefault = false;
            BaseUnit = "K";
            NumberOfDecimalDigits = 1;
    ...
    public class ExternalTemperature : SurfaceEntry
    {
        public ExternalTemperature()
        {
            Name = "Total air temp.";
            Description =
                "Measured by means of a sensor positioned in the airflow, kinetic heating will result, raising the temperature measured above the Static ambient temperature.";
            Category = MicroEntryCategory.Surface;
            IsDefault = false;
            BaseUnit = "K";
            NumberOfDecimalDigits = 1;
    ...
    public class ImpactLatitude : SurfaceEntry
    {
        ...
        public override void RefreshData()
        {
            ...
            OrbitExtensions.GetOrbitalParametersAtUT(Utility.ActiveVessel, Utility.ActiveVessel.Orbit.EndUT,
    ...
    public class ImpactRegion : SurfaceEntry
    {
        ...
        public override void RefreshData()
        {
            ...
            var position = new Position(Utility.ActiveVessel.Orbit.ReferenceFrame,
                Utility.ActiveVessel.Orbit.GetRelativePositionAtUT(Utility.ActiveVessel.Orbit.EndUT));
            OrbitExtensions.GetOrbitalParametersAtUT(Utility.ActiveVessel, Utility.ActiveVessel.Orbit.EndUT,
                out double latitude, out double longitude, out double altitude);

            var scienceRegionDefinition =
                GameManager.Instance.Game.ScienceManager.ScienceRegionsDataProvider.GetScienceRegionAt(bodyName,
