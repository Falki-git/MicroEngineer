    ...
    public static class AeroForces
    {
        ...
        public static double AngleOfAttack
        {
            get
            {
                ...
                ISimulationObjectView simulationViewIfLoaded =
                    GameManager.Instance.Game.ViewController.GetSimulationViewIfLoaded(Utility.ActiveVessel
                        .SimulationObject);
                if (simulationViewIfLoaded != null)
                {
                    Vector3d normalized = GameManager.Instance.Game.UniverseView.PhysicsSpace
                        .VectorToPhysics(Utility.ActiveVessel.SurfaceVelocity).normalized;
