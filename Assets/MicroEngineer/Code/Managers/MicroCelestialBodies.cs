...
namespace MicroEngineer.Managers
{
    public class MicroCelestialBodies
    {
        ...
        private static readonly ILogger Logger = ReduxLib.ReduxLib.GetLogger("MicroEngineer.MicroCelestialBodies");
        ...
        public void InitializeBodies()
        {
            ...
            {
                Logger.LogInfo("Skipping CelestialBodies build as they're already populated.");
                return;
            }
            ...
            {
                Logger.LogError("Error retrieving CelestialBodies from GameManager.Instance.Game.UniverseModel.");
                return;
            }
            ...
            Logger.LogInfo("CelestialBodies successfully built.");
            return;
        }
        ...
        public double GetTwrFactor(string bodyName)
        {
            ...
            CelestialBody targetBody =
                Bodies.Find(t => t.Name.ToLowerInvariant() == bodyName.ToLowerInvariant()) ?? null;
