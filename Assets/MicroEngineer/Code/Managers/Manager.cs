    ...
    public class Manager
    {
        ...
        public void DoFlightUpdate()
        {
            ...
            if (Utility.GameState != null &&
                (Utility.GameState.GameState == GameState.FlightView ||
                 Utility.GameState.GameState == GameState.Map3DView) && isFlightActive)
            {
        ...
        public List<BaseEntry> InitializeEntries()
        {
            ...
            Type[] excludedTypes = new[]
            {
                typeof(BaseEntry), typeof(BodyEntry), typeof(FlightEntry),
            ...
            Type[] entryTypes = types.Where(t => typeof(BaseEntry).IsAssignableFrom(t) && !excludedTypes.Contains(t))
                .ToArray();
